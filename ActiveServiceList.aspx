<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ActiveServiceList.aspx.cs" Inherits="ActiveServicetList" %>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <asp:TextBox ID="text_ServiceID" runat="server" CssClass="form-control" AutoPostBack="false" placeholder="Enter Service ID"></asp:TextBox>
                            </div>
                            ...
                            <div class="col-lg-3">
                                <asp:DropDownList ID="dd_requested" runat="server" CssClass="form-control" AutoPostBack="false">
                                    <asp:ListItem Text="All" Value="All"></asp:ListItem>
