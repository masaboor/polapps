<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AssignComplaint.aspx.cs" Inherits="ViewTicket" %>
            ...
            <div class="panel panel-red">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <div class="col-lg-2">
                                <label>Assigning Comments</label>
                            </div>
                            <div class="col-lg-8">
