<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="AssignComplaintList.aspx.cs" Inherits="AssignComplaint" %>
                ...
                <div class="col-lg-12">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <asp:Button ID="btn_search" runat="server" Text="Show Complaints" CssClass="btn btn-info" OnClick="btn_search_Click" />
                            </div>
        ...
        <asp:GridView ID="gv_ticketList" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowCommand="gv_ticketList_RowCommand">
            <Columns>
                ...
                <asp:TemplateField HeaderText="Assign">
                    <ItemTemplate>
                        <asp:LinkButton ID="lb_Assign" runat="server" Text='Assign' CommandName="Assign"></asp:LinkButton>
                    </ItemTemplate>
                </asp:TemplateField>
