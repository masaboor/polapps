<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="Change.aspx.cs" Inherits="CreateChange" %>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_ChangeRequestor" runat="server" CssClass="form-control" AutoPostBack="false"
                                                    DataSourceID="SqlDataSource1" DataTextField="Employee_Name" DataValueField="Employee_ID">
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT Employee_ID = '0', Employee_name = ' Please Select'
                                                                    UNION
                                                                    SELECT Employee_ID + '#' + email 'Employee_ID',Employee_name 
                                                                    FROM Employee
                                                                    Order BY Employee_name"></asp:SqlDataSource>
                                            </div>
                                            <div class="col-lg-2">
                                            </div>
                                            <div class="col-lg-3">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_Category" runat="server" CssClass="form-control" AutoPostBack="true"
                                                    ...
                                                    DataSourceID="SqlDataSource2" DataTextField="Type_Desc" DataValueField="Type_ID">
                                                    <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                            ...
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_SubCategory" runat="server" CssClass="form-control" AutoPostBack="False"
                                                    DataSourceID="SqlDataSource3" DataTextField="subType_Desc" DataValueField="subType_ID">
                                                    <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT subType_ID = '0', subType_Desc = ' Please Select'
                                                                    UNION
                                                                    SELECT subType_ID, subType_Desc 
                                                                    FROM Change_Subtype
                                                                    WHERE Type_Id = @TypeID
                                                                    AND status = '1'">
                                                    <SelectParameters>
                                                        <asp:ControlParameter Name="TypeID" ControlID="dd_Category" PropertyName="SelectedValue" />
                                                    </SelectParameters>
                                                </asp:SqlDataSource>
                                            </div>
                                        </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-4">
                                                <div style="height: 200px; overflow: scroll">
                                                    <asp:CheckBoxList ID="dd_ServiceAffected" runat="server" AutoPostBack="false" RepeatDirection="Vertical"
                                                        DataSourceID="SqlDataSource4" DataTextField="service_description" DataValueField="service_id">
                                                    </asp:CheckBoxList>
                                                    <asp:SqlDataSource ID="SqlDataSource4" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                        SelectCommand="SELECT service_id, service_description
                                                                    FROM change_services_new
                                            ...
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_ReasonForChange" runat="server" CssClass="form-control" AutoPostBack="false"
                                                    DataSourceID="SqlDataSource5" DataTextField="reason_description" DataValueField="reason_id">
                                                    <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource5" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT reason_id = '0', reason_description = ' Please Select'
                                                                    UNION
                                                                    SELECT reason_id, reason_description
                                                                    FROM change_reason"></asp:SqlDataSource>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-lg-10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_Impact" runat="server" CssClass="form-control" AutoPostBack="false"
                                                    DataSourceID="SqlDataSource6" DataTextField="Impact_Description" DataValueField="Impact_ID">
                                                    <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource6" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT Impact_ID = '0', Impact_Description = ' Please Select'
                                                                    UNION
                                                                    SELECT Impact_ID, Impact_Description
                                                                    FROM change_impact"></asp:SqlDataSource>
                                            </div>
                                            <div class="col-lg-2">
                                                <label>Urgency</label>
                                            </div>
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_Urgency" runat="server" CssClass="form-control" AutoPostBack="true"
                                                    OnSelectedIndexChanged="dd_Urgency_SelectedIndexChanged"
                                                    DataSourceID="SqlDataSource7" DataTextField="urgency_description" DataValueField="urgency_id">
                                                    <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource7" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT urgency_id = '0', urgency_description = ' Please Select'
                                                                    UNION
                                                                    SELECT urgency_id, urgency_description 
                                                                    FROM change_urgency"></asp:SqlDataSource>
                                            </div>
                                        </div>
                                    </div>
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_Priority" runat="server" CssClass="form-control" AutoPostBack="false"
                                                    DataSourceID="SqlDataSource8" DataTextField="Priority_desc" DataValueField="Priority_id">
                                                    <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource8" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT Priority_id = '0', Priority_desc = ' Please Select'
                                                                    UNION
                                                                    SELECT Priority_ID, Priority_Desc 
                                                                    FROM Priority"></asp:SqlDataSource>
                                            </div>
                                            <div class="col-lg-2">
                                                <label>Stage</label>
                                            </div>
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_Stage" runat="server" CssClass="form-control" AutoPostBack="false"
                                                    DataSourceID="SqlDataSource9" DataTextField="stage_description" DataValueField="stage_id">
                                                    <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource9" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT stage_id = '0', stage_description = ' Please Select'
                                                                    UNION
                                                                    SELECT stage_id, stage_description
                                                                    FROM change_stage"></asp:SqlDataSource>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_Risk" runat="server" CssClass="form-control" AutoPostBack="false"
                                                    DataSourceID="SqlDataSource10" DataTextField="risk_description" DataValueField="risk_id">
                                                    <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource10" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT risk_id = '0', risk_description = ' Please Select'
                                                                    UNION
                                                                    SELECT risk_id, risk_description
                                                                    FROM change_risk"></asp:SqlDataSource>
                                            </div>
                                            <div class="col-lg-2">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <asp:TextBox ID="txt_Details" runat="server" CssClass="form-control" TextMode="MultiLine"
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <asp:TextBox ID="txt_BackoutPlan" runat="server" CssClass="form-control" TextMode="MultiLine"
                                                    placeholder="Enter Backout Plan"></asp:TextBox>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                        ...
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_Approver" runat="server" CssClass="form-control" AutoPostBack="false"
                                                    DataSourceID="SqlDataSource11" DataTextField="Employee_name" DataValueField="Employee_ID">
                                                    <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource11" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT e.Employee_ID + '#' + e.email 'Employee_ID', e.Employee_name 'Employee_name'
                                                                    FROM Type_AssignmentGrp ta
                                                                    INNER JOIN Employee e ON ta.dept_id = e.Dept_ID
											                        INNER JOIN AssignmentGrp_Emp ag ON ag.Group_ID = e.Dept_ID AND ag.Employee_ID = e.Employee_ID
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <asp:DropDownList ID="dd_MainImplementer" runat="server" CssClass="form-control" AutoPostBack="false"
                                                    DataSourceID="SqlDataSource12" DataTextField="Employee_name" DataValueField="Employee_ID">
                                                    <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                </asp:DropDownList>
                                                <asp:SqlDataSource ID="SqlDataSource12" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT Employee_ID = '0', Employee_name = ' Please Select'
                                                                    UNION
                                                                    SELECT e.Employee_ID + '#' + e.email 'Employee_ID', e.Employee_name 
                                                                    FROM Type_AssignmentGrp ta                                           
                                                                    INNER JOIN AssignmentGrp_Emp ag ON ta.Dept_ID = ag.Group_ID
											                        INNER JOIN Employee e ON ag.Employee_ID = e.Employee_ID
                                                                    WHERE ta.type_id = @TypeID and ag.Status <> 0
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-2">
                                                <asp:Button ID="btn_modal" class="btn btn-primary btn-lg" data-toggle="modal" data-target="#myModal" Text="Add Task">Add Task
                                                <asp:Button />
                                            </div>
                                            <div class="col-lg-3">
                                            </div>
                                                ...
                                                <div class="modal-dialog">
                                                    <div class="modal-content">
                                                        <div class="modal-header">
                                                            ...
                                                            <h4 class="modal-title" id="myModalLabel">Add Additional Tasks for Change</h4>
                                                        </div>
                                                        <div class="modal-body">
                                                            <label>Implementer</label>
                                                            <asp:DropDownList ID="dd_Implementer" runat="server" CssClass="form-control" AutoPostBack="false"
                                                                DataSourceID="SqlDataSource13" DataTextField="Employee_name" DataValueField="Employee_ID">
                                                                <%--<asp:ListItem Text="Please Select" Value="0"></asp:ListItem>--%>
                                                            </asp:DropDownList>
                                                            <asp:SqlDataSource ID="SqlDataSource13" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                                SelectCommand="SELECT Employee_ID = '0', Employee_name = ' Please Select'
                                                                    UNION
                                                                    SELECT e.Employee_ID + '#' + e.email 'Employee_ID', e.Employee_name 
                                                                    FROM Type_AssignmentGrp ta                                           
                                                                    INNER JOIN AssignmentGrp_Emp ag on ta.Dept_ID = ag.Group_ID
										                            INNER JOIN Employee e on ag.Employee_ID = e.Employee_ID
                                                                    WHERE ta.type_id = @TypeID and ag.Status = '1'
                                                                    ORDER BY Employee_name">
                                                                <SelectParameters>
                                                                    <asp:ControlParameter Name="TypeID" ControlID="dd_Category" PropertyName="SelectedValue" />
                                                                </SelectParameters>
                                                            ...
                                                            <asp:TextBox ID="txt_TaskEnd" runat="server" CssClass="form-control" AutoPostBack="false" placeholder="Ending Date"></asp:TextBox>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <asp:GridView ID="gv_taskList" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowCommand="gv_taskList_RowCommand">
                                                <Columns>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-3">
                                    <asp:Button ID="btn_SaveDraft" runat="server" Text="Save as Draft" CssClass="btn btn-primary btn-lg btn-info" OnClick="btn_SaveDraft_Click" />
                                </div>
                                <div class="col-lg-9">
