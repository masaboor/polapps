<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ChangeActionList.aspx.cs" Inherits="TicketList" %>
    ...
    <div class="form-group">
        ...
        <asp:GridView ID="gv_ticketList" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowCommand="gv_ticketList_RowCommand">
            <Columns>
                ...
                <asp:BoundField DataField="Approver1" HeaderText="Approver 1" SortExpression="Change_ID" />
                <asp:BoundField DataField="Approver2" HeaderText="Approver 2" SortExpression="Change_ID" />
