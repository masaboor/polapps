<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ChangeEditDraft.aspx.cs" Inherits="Change" %>
                ...
                <div class="panel panel-primary">
                    ...
                    <div class="panel-body">
                                            ...
                                            <div class="col-lg-3">
                                                ...
                                                <asp:SqlDataSource ID="SqlDataSource3" runat="server" ConnectionString="<% $ connectionStrings:ConString %>"
                                                    SelectCommand="SELECT subType_ID = '0', subType_Desc = ' Please Select'
                                                                    ...
                                                                    AND status = '1'">
                                                    <SelectParameters>
                                                        <asp:ControlParameter Name="TypeID" ControlID="dd_Category" PropertyName="SelectedValue" DefaultValue="0" />
                                                    </SelectParameters>
                                                </asp:SqlDataSource>
                                            </div>
                                        </div>
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-3">
                                    <asp:Button ID="btn_SaveDraft" runat="server" Text="Update Draft" CssClass="btn btn-primary btn-lg btn-info" OnClick="btn_SaveDraft_Click" />
                                </div>
                                <div class="col-lg-9">
                                    <asp:Button ID="btn_Save" runat="server" Text="Submit Change" CssClass="btn btn-outline btn-primary btn-lg btn-block"
