<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ChangeImplement_old.aspx.cs" Inherits="Change" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form-group">
        ...
        <div id="div_success" runat="server" visible="false" class="alert alert-success">
            Change has been Implemented Successfully! Change ID is 
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-3">
                                                <asp:TextBox ID="txt_ActualStart" runat="server" CssClass="form-control" AutoPostBack="false" placeholder="Starting Date"></asp:TextBox>
                                                <ajaxx:CalendarExtender ID="CalendarExtender1" runat="server" TargetControlID="txt_ActualStart" Format="dd/MM/yyyy"></ajaxx:CalendarExtender>
                                            ...
                                            <div class="col-lg-3">
                                                <asp:TextBox ID="txt_ActualEnd" runat="server" CssClass="form-control" AutoPostBack="false" placeholder="Ending Date"></asp:TextBox>
                                                <ajaxx:CalendarExtender ID="CalendarExtender2" runat="server" TargetControlID="txt_ActualEnd" Format="dd/MM/yyyy"></ajaxx:CalendarExtender>
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-10">
                                                <asp:Button ID="btn_Save" runat="server" Text="Implement Change" CssClass="btn btn-outline btn-primary btn-lg btn-block" OnClick="btn_Save_Click" />
