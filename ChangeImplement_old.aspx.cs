...
public partial class Change : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        if (!IsPostBack)
        {
            ...
            txt_ActualStart.Text = DateTime.Now.ToString("dd/MM/yyyy");
            txt_ActualEnd.Text = DateTime.Now.ToString("dd/MM/yyyy");
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        string datetime1 = txt_ActualStart.Text + " " + addZero(TimeSelector3.Hour.ToString()) + ":" + addZero(TimeSelector3.Minute.ToString()) + ":" + addZero(TimeSelector3.Second.ToString()) + ":000 " + TimeSelector3.AmPm;
        ...
        string datetime2 = txt_ActualEnd.Text + " " + addZero(TimeSelector4.Hour.ToString()) + ":" + addZero(TimeSelector4.Minute.ToString()) + ":" + addZero(TimeSelector4.Second.ToString()) + ":000 " + TimeSelector4.AmPm;

        //lbl_status.Text = datetime1;
        //return;

        string ticketQuery = "update change set status = '4', stage_ID = '5', modify_datetime = getdate(), modify_user = '" + Session["UserID"].ToString() + "', implement_comments = '" + txt_ImplementationComments.Text + "', implement_date = getdate(), implement_DateTime = getdate(), Actual_start = CONVERT(datetime, '" + datetime1 + @"', 103), Actual_end = CONVERT(datetime, '" + datetime2 + @"', 103), change_result = '" + dd_Result.SelectedValue + "' where change_ID = '" + ChangeID + "'";
        ...
        try
        {
            ...
            string logQuery = @"insert into change_log (change_id, status, status_by, status_datetime, status_description, status_comments)
                                            values
                                            ('" + ChangeID + @"', '4', '" + Session["UserID"].ToString() + @"', getdate(), '" + Session["Username"].ToString() + " Implemented the Change" + @"','" + txt_ImplementationComments.Text + "')";
            ...
            string emailBody = @"<p>Dear <b>All</b>, a Change has been implemented in CIS by <b>" + Session["Username"].ToString() + @"</b>, the Details of the change are given below:  </p>
            ...
            emailBody += @"</p>
                                                ...
                                                <tr>
                                                    <td colspan=""1"">
                                                     ...
                                                     <td colspan=""1"">
                                                       <p> " + dd_Result.SelectedItem.Text + @"</p>
                                                    </td>
                                                   <td colspan=""1"">
                                                    ...
                                                    <tr>
                                                    <td colspan=""1"">
                                                        <b>Implementation Comments: </b>
                                                    </td>
                                                     <td colspan=""1"">
                                                       <p> " + txt_ImplementationComments.Text + @"</p>
                                                    </td>
                                                   <td colspan=""1"">
            ...
            emailBody += @"
                                            ...
                                            <p>To view this change, please click on this link:   <a href=""http://10.85.1.249/CIS/Login.aspx""> Redirect me to CIS</a> </p>
            ...
            string emailQuery = @"insert into Email_Logs (To_Address, Email_Subject, Email_Body, Sent_Flag, From_Application, From_Module, Confirmation_Msg, From_User, Created_Date)
                                                values ('" + reviewerEmail[1] + ";"+approverEmail[1]+";"+requestorEmail[1]+"', 'Change Implemented, Change ID: " + ChangeID + @"', '" + emailBody + @"', 'N', 'CIS', 'Change', '', '" + Session["UserID"].ToString() + @"', GETDATE());
                                                ";
        ...
        {
            lbl_status.Text = "Change Implementation Failed!! Please try again!";
