...
public partial class TicketList : System.Web.UI.Page
{
    ...
    public void GetChanges()
    {
        ...
        string query = @"select t.change_id, 
							...
							from change_new t
                              ...
                              on  t.approver2 = e3.Employee_ID where t.status = '1' and t.Approve1_Comments is null and t.Approve2_Comments is null and t.requestor = '" + Session["UserID"].ToString() + @"'
    ...
    protected void gv_ticketList_RowCommand(object sender, GridViewCommandEventArgs e)
    {
        if (e.CommandName == "Show")
        {
            ...
            Response.Redirect("ChangeEditing.aspx?ChangeID=" + lb.Text);
        }
    }
