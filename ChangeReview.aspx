<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ChangeReview.aspx.cs" Inherits="Change" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form-group">
        ...
        <div id="div_success" runat="server" visible="false" class="alert alert-success">
            Change has been Reviewed Successfully! Change ID is 
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            ...
                                            <div class="col-lg-8">
                                                <asp:TextBox ID="txt_ReviewComments" runat="server" CssClass="form-control" TextMode="MultiLine" placeholder="Enter Review Comments" Enabled="true"></asp:TextBox>
                                            </div>
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-7">
                                                <asp:Button ID="btn_Save" runat="server" Text="Review Change" CssClass="btn btn-outline btn-primary btn-lg btn-block" OnClick="btn_Save_Click" />
