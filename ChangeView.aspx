<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ChangeView.aspx.cs" Inherits="Change" %>
                    ...
                    <div class="panel-heading">
                        <div class="row">
                            ...
                            <div class="col-lg-6">
                                ...
                                <asp:Label ID="lbl_Change_Title" runat="server" Text="Ticket Title" Font-Bold="true" visible="false"></asp:Label>
                            </div>
                                    ...
                                    <div class="row">
                                        ...
                                        <asp:GridView ID="gv_taskList" runat="server" CssClass="table table-striped table-bordered table-hover" AutoGenerateColumns="False" OnRowCommand="gv_taskList_RowCommand">
                                            <Columns>
                                                ...
                                                <asp:BoundField DataField="Implement_Comments" HeaderText="Implementation Comments" SortExpression="Task_ID" />
                                                <asp:BoundField DataField="Task_Result" HeaderText="Task Result" SortExpression="Task_ID" />
