...
//            q = cmd.ExecuteNonQuery();
    ...
    protected void btn_Active_Click(object sender, EventArgs e)
    {
        ...
        string ticketQuery = "update Complaint set status = '" + dd_Status.SelectedValue + "', modify_datetime = getdate(), modify_user = '" + Session["UserID"].ToString() + "', status_comments = '" + txt_Comments.Text + "' where Complaint_ID = '" + ticketID + "'";
