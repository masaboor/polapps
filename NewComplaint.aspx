<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="NewComplaint.aspx.cs" Inherits="NewTicket" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form-group">
        ...
        <div id="div_success" runat="server" visible="false" class="alert alert-success">
            Complaint has been created Successfully! Complaint ID is 
                        ...
                        <div class="form-group">
                            <div class="row">
                                <div class="col-lg-10">
                                    ...
                                    <asp:Button ID="btn_Save" runat="server" Text="Create Complaint" CssClass="btn btn-outline btn-primary btn-lg btn-block" OnClick="btn_Save_Click" />
