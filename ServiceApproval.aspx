<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ServiceApproval.aspx.cs" Inherits="Change" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="Server">
    ...
    <div class="form-group">
        ...
        <div id="div_success" runat="server" visible="false" class="alert alert-success">
            Service has been Approved Successfully! Change ID is 
                            ...
                            <div class="panel-body">
                                ...
                                <div class="col-lg-10">
                                    ...
                                    <div class="form-group">
                                        <div class="row">
                                            <div class="col-lg-7">
                                                <asp:Button ID="btn_Save" runat="server" Text="Approve Service" CssClass="btn btn-outline btn-primary btn-lg btn-block" OnClick="btn_Save_Click" />

                                            </div>


                                            <div class="col-lg-2">
                                                <asp:Button ID="btn_Reject" runat="server" Text="Reject Service" CssClass="btn btn-danger" OnClick="btn_Reject_Click" />
