...
public partial class Change : System.Web.UI.Page
{
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        string ticketQuery = "update service set status = '2', stage_ID = '3', modify_datetime = getdate(), modify_user = '" + Session["UserID"].ToString() + "', approve_comments = '" + txt_ApprovalComments.Text + "', approve_date = getdate(), approve_DateTime = getdate() where service_ID = '" + ChangeID + "'";
        ...
        try
        {
            ...
            string logQuery = @"insert into service_log (service_ID, status, status_by, status_datetime, status_description, status_comments)
                                            values
                                            ('" + ChangeID + @"', '2', '" + Session["UserID"].ToString() + @"', getdate(), '" + Session["Username"].ToString() + " Approved the Service" + @"','" + txt_ApprovalComments.Text + "')";
        ...
        {
            lbl_status.Text = "Service Approval Failed!! Please try again!";
            showAlert("Service Approval Failed!! Please try again!");
        }
    }
    protected void btn_Reject_Click(object sender, EventArgs e)
    {
        ...
        string ticketQuery = "update service set status = '9', modify_datetime = getdate(), modify_user = '" + Session["UserID"].ToString() + "', approve_comments = '" + txt_ApprovalComments.Text + "', approve_date = getdate(), approve_DateTime = getdate() where service_ID = '" + ChangeID + "'";
        ...
        try
        {
            ...
            string logQuery = @"insert into service_log (service_id, status, status_by, status_datetime, status_description, status_comments)
                                            values
                                            ('" + ChangeID + @"', '9', '" + Session["UserID"].ToString() + @"', getdate(), '" + Session["Username"].ToString() + " Rejected the Service" + @"','" + txt_ApprovalComments.Text + "')";
        ...
        {
            lbl_status.Text = "Service Rejection Failed!! Please try again!";
            showAlert("Service Rejection Failed!! Please try again!");
        }
    }
