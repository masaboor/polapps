...
public partial class ServiceMaster : System.Web.UI.Page
{
    ...
    public void GetMaxServiceId()
    {
        ...
        SqlCommand cmd = new SqlCommand(@"select case when LEN(max(CAST(service_id as int)) + 1) = 3
                                         ...
                                         then (REPLICATE('0',1) + CAST((max(CAST(service_id as int)) + 1) as nvarchar))
                                           ...
                                           end as 'serviceID' from Service_Services_New
    ...
    protected void btn_Save_Click(object sender, EventArgs e)
    {
        ...
        try
        {
            ...
            string changeQuery = "insert into Service_Services_New (Service_ID, Service_Description)  values ('" + serviceID + "','" + serviceDesc + "')";
    ...
    public void GridViewRefresh()
    {
        ...
        SqlConnection con = new SqlConnection(constr);
        SqlCommand cmd = new SqlCommand(@"select * from Service_Services_New");
        SqlDataAdapter sda = new SqlDataAdapter();
        cmd.Connection = con;
        sda.SelectCommand = cmd;
        DataTable dt = new DataTable();
    ...
    public DataTable Check_Duplicates(string mainid)
    {
        ...
        SqlConnection con = new SqlConnection(constr);
        string activityQuery = @"select * from Service_Services_New where service_id = '" + mainid + "'";
