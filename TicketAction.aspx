<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TicketAction.aspx.cs" Inherits="ViewTicket" %>
        ...
        <div class="col-lg-12">
                        ...
                        <div class="form-group">
                         ...
                         <div class="form-group">
                            <div class="row">
                                ...
                                <div class="col-lg-3">
                                    <asp:Label ID="txt_recipent" runat="server" CssClass="form-control" AutoPostBack="false"></asp:Label>
                                </div>
            ...
            <div class="panel panel-red">
                ...
                <div class="panel-body">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-4">
                                <asp:Button ID="btn_AddTaskAttachment" runat="server" Text="Add Status Attachment" CssClass="btn btn-primary" OnClick="btn_AddTaskAttachment_Click" />
                            </div>
                ...
                <div class="panel-footer">
                    ...
                    <div class="form-group">
                        <div class="row">
                            <asp:Button ID="btn_Active" runat="server" Text="Update Status" CssClass="btn btn-primary" OnClick="btn_Active_Click" />
                            <asp:Button ID="btn_Resolve" runat="server" Text="Resolve Ticket" CssClass="btn btn-success" OnClick="btn_Resolve_Click" />
                        </div>
                    </div>
                    ...
                    <asp:Button ID="btn_ReAssign" runat="server" Text="Re-Assign Ticket" CssClass="btn btn-info" OnClick="btn_ReAssign_Click" />
