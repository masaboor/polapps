<%@ Page Title="" Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="TicketActionStatus.aspx.cs" Inherits="TicketActionStatus" %>
                ...
                <div class="panel-footer">
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <asp:Button ID="btn_Active" Visible="true" runat="server" Text="Update Status" CssClass="btn btn-primary" OnClick="btn_Active_Click" />
                            <%--<asp:Button ID="btn_Resolve" Visible="false" runat="server" Text="Resolve Ticket" CssClass="btn btn-success" OnClick="btn_Resolve_Click" />--%>
                        </div>
                    </div>
                    ...
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-lg-3">
                                <asp:DropDownList ID="dd_AssignToPerson" Visible="true" runat="server" CssClass="form-control" AutoPostBack="false">
                                    <asp:ListItem Text="Please Select" Value="0"></asp:ListItem>
                                </asp:DropDownList>
                            </div>
                            <asp:Button ID="btn_ReAssign" Visible="true" runat="server" Text="Re-Assign Ticket" CssClass="btn btn-info" OnClick="btn_ReAssign_Click" />
                        </div>
                    </div>
